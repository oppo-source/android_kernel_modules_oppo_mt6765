...
int connsys_a_die_efuse_read_mt6983_gen(unsigned int efuse_addr) {
	int ret[4];
...
int connsys_a_die_cfg_adie6637_PART2_mt6983_gen(unsigned int hw_ver_id)
{
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		consys_spi_read_nolock_mt6983(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_BT0_BG_TIME, &val);
	...
	#ifndef CONFIG_FPGA_EARLY_PORTING
		consys_spi_read_nolock_mt6983(SYS_SPI_TOP, CONSYS_GEN_ADIE6637_ATOP_RG_TOP_XO_02, &val);
