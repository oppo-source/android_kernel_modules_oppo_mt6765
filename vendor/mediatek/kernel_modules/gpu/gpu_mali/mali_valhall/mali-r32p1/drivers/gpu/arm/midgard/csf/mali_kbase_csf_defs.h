...
/**
 * struct kbase_csf_user_reg_context - Object representing
...
struct kbase_csf_user_reg_context {
	...
	struct file *filp;
	struct list_head link;
	bool dummy_page_mapped;
	bool real_page_mapped;
};
...
/**
 * struct kbase_csf_user_reg - Object representing
 *
 * @dummy_page:             Address of the dummy page that is mapped in place
