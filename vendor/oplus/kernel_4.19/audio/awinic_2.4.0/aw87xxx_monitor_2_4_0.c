...
void aw87xxx_2_4_0_monitor_stop(struct aw_monitor *monitor)
{
	struct aw87xxx *aw87xxx =
		container_of(monitor, struct aw87xxx, monitor);
...
void aw87xxx_2_4_0_monitor_start(struct aw_monitor *monitor)
{
	struct aw87xxx *aw87xxx =
		container_of(monitor, struct aw87xxx, monitor);
	int ret = 0;
...
void aw87xxx_2_4_0_monitor_init(struct device *dev, struct aw_monitor *monitor,
				struct device_node *dev_node)
{
	int ret = -1;
	struct aw87xxx *aw87xxx =
...
void aw87xxx_monitor_exit(struct aw_monitor *monitor)
{
	...
	aw87xxx_2_4_0_monitor_stop(monitor);
