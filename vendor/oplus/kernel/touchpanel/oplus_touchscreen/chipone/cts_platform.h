...
#define cts_err(fmt, ...)   \
    cts_log(CTS_DRIVER_LOG_ERROR, "<E> [TP] CTS-" LOG_TAG " " fmt"\n", ##__VA_ARGS__)
#define cts_warn(fmt, ...)  \
    cts_log(CTS_DRIVER_LOG_WARN,  "<W> [TP] CTS-" LOG_TAG " " fmt"\n", ##__VA_ARGS__)
#define cts_info(fmt, ...)  \
    cts_log(CTS_DRIVER_LOG_INFO,  "<I> [TP] CTS-" LOG_TAG " " fmt"\n", ##__VA_ARGS__)
#define cts_dbg(fmt, ...)   \
    cts_log(CTS_DRIVER_LOG_DEBUG, "<D> [TP] CTS-" LOG_TAG " " fmt"\n", ##__VA_ARGS__)
