...
static int oplus_chg_vphy_get_curve_current(struct oplus_chg_ic_dev *ic_dev, int *curr)
{
	...
	rc = oplus_chg_ic_func(va->vphy, OPLUS_IC_FUNC_VOOCPHY_GET_CURVE_CURR, curr);
	if (rc < 0)
				   ...
				   enum oplus_chg_ic_func func_id)
{
	...
	case OPLUS_IC_FUNC_VOOC_GET_IC_DEV:
		...
		break;
	case OPLUS_IC_FUNC_VOOCPHY_GET_CURVE_CURR:
		func = OPLUS_CHG_IC_FUNC_CHECK(OPLUS_IC_FUNC_VOOCPHY_GET_CURVE_CURR,
